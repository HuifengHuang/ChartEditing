...
function createControlTemplates() {
  const controls = {
    ...
    legend_direction: {
      ...
      impactPolicy: "show-affected-controls",
      affectedBindings: [
        "legend.items.waiting.id",
        "legend.items.waiting.label",
        "legend.items.waiting.color",
        "legend.items.corridor.id",
        "legend.items.corridor.label",
        "legend.items.corridor.color",
      ],
    },
    legend_waiting_id: {
      id: "legend_waiting_id",
      label: "Waiting Legend ID",
      controlType: "text",
      operationType: "update",
      bindingMode: "single",
      bind: "source_data.legend.items.waiting.id",
      valueType: "string",
    },
    legend_waiting_label: {
      id: "legend_waiting_label",
      label: "Waiting Legend Label",
      controlType: "text",
      operationType: "update",
      bindingMode: "single",
      bind: "source_data.legend.items.waiting.label",
      valueType: "string",
    },
    legend_waiting_color: {
      id: "legend_waiting_color",
      label: "Waiting Legend Color",
      controlType: "color",
      operationType: "update",
      bindingMode: "single",
      bind: "source_data.legend.items.waiting.color",
      valueType: "color",
    },
    legend_corridor_id: {
      id: "legend_corridor_id",
      label: "Corridor Legend ID",
      controlType: "text",
      operationType: "update",
      bindingMode: "single",
      bind: "source_data.legend.items.corridor.id",
      valueType: "string",
    },
    legend_corridor_label: {
      id: "legend_corridor_label",
      label: "Corridor Legend Label",
      controlType: "text",
      operationType: "update",
      bindingMode: "single",
      bind: "source_data.legend.items.corridor.label",
      valueType: "string",
    },
    legend_corridor_color: {
      id: "legend_corridor_color",
      label: "Corridor Legend Color",
      controlType: "color",
      operationType: "update",
      bindingMode: "single",
      bind: "source_data.legend.items.corridor.color",
      valueType: "color",
    },
  };
...
const AFFECTED_CONTROL_REGISTRY = {
  ...
  "legend.items.waiting.id": {
    ...
    priority: "detail",
    control: CONTROL_TEMPLATES.legend_waiting_id,
  },
  "legend.items.waiting.label": {
    sectionId: "legend_detail",
    sectionTitle: "Legend Items Detail",
    priority: "detail",
    control: CONTROL_TEMPLATES.legend_waiting_label,
  },
  "legend.items.waiting.color": {
    sectionId: "legend_detail",
    sectionTitle: "Legend Items Detail",
    priority: "detail",
    control: CONTROL_TEMPLATES.legend_waiting_color,
  },
  "legend.items.corridor.id": {
    sectionId: "legend_detail",
    sectionTitle: "Legend Items Detail",
    priority: "detail",
    control: CONTROL_TEMPLATES.legend_corridor_id,
  },
  "legend.items.corridor.label": {
    sectionId: "legend_detail",
    sectionTitle: "Legend Items Detail",
    priority: "detail",
    control: CONTROL_TEMPLATES.legend_corridor_label,
  },
  "legend.items.corridor.color": {
    sectionId: "legend_detail",
    sectionTitle: "Legend Items Detail",
    priority: "detail",
    control: CONTROL_TEMPLATES.legend_corridor_color,
  },
};
